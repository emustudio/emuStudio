...
public class Main {
    ...
    public static void main(String... args) {
        ...
        for (i = 0; i < args.length; i++) {
            ...
            if ((arg.equals("--output") || arg.equals("-o")) && ((i + 1) < args.length)) {
                ...
                System.out.println(new RAMCompiler(0L, new ContextPool()).getVersion());
                return;
            } else {
                break;
            }
        ...
        RAMCompiler compiler = new RAMCompiler(0L, new ContextPool());
    ...
    private static void printHelp() {
        System.out.println("Syntax: java -jar ramc-ram.jar [-o outputFile] inputFile\nOptions:");
