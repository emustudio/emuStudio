...
public class InstructionTest {
    ...
    public void testToString() {
        Instruction instr = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
    ...
    public void testHashCode() {
        Instruction instr1 = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
        Instruction instr2 = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
    ...
    public void testNotEqualsDifferentTokenType() {
        Instruction instr1 = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
        Instruction instr2 = new Instruction(SSEMParser.STO, 10, POS, Optional.of(POS));
    ...
    public void testNotEqualsDifferentOperand() {
        Instruction instr1 = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
        Instruction instr2 = new Instruction(SSEMParser.LDN, 20, POS, Optional.of(POS));
        assertNotEquals(instr1, instr2);
    }
    ...
    public void testNotEqualsNull() {
        Instruction instr = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
        assertFalse(instr.equals(null));
    }

    @Test
    public void testNotEqualsDifferentClass() {
        Instruction instr = new Instruction(SSEMParser.LDN, 10, POS, Optional.of(POS));
        assertFalse(instr.equals("string"));
    }

    @Test
    public void testGetOpcodeJMP() {
        Instruction instr = new Instruction(SSEMParser.JMP, 0, POS, Optional.of(POS));
        assertEquals(0, instr.getOpcode());
    }

    @Test
    public void testGetOpcodeJPR() {
        Instruction instr = new Instruction(SSEMParser.JPR, 0, POS, Optional.of(POS));
        assertEquals(4, instr.getOpcode());
    }

    @Test
    public void testGetOpcodeSUB() {
        Instruction instr = new Instruction(SSEMParser.SUB, 0, POS, Optional.of(POS));
        assertEquals(1, instr.getOpcode());
    }

    @Test
    public void testGetOpcodeCMP() {
        Instruction instr = new Instruction(SSEMParser.CMP, 0, POS, Optional.empty());
    ...
    public void testUnknownInstructionThrows() {
        ...
        new Instruction(9999, 0, POS, Optional.empty());
    }

    @Test(expected = CompileException.class)
    public void testOperandOutOfBoundsThrows() {
        new Instruction(SSEMParser.LDN, 32, POS, Optional.of(POS));
    }
