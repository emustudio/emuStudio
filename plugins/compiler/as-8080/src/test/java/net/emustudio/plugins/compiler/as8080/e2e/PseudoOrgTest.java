...
public class PseudoOrgTest extends AbstractCompilerTest {
    ...
    public void testORGwithInclude() {
        ...
        assertProgram(0, 0, 0, 0xCD, 6, 0, 0x3E, 0, 0xC9);
    }
    ...
    public void testORGwithDoubleInclude() {
        ...
        assertProgram(0, 0, 0, 0xCD, 0x09, 0, 0x3E, 0, 0xC9, 0x3E, 0, 0xC9);
    }
    ...
    public void testORGwithDoubleIncludeAndJMPafter() {
        ...
        assertProgram(0, 0, 0, 0xC3, 0x0C, 0, 0x3E, 0, 0xC9, 0x3E, 0, 0xC9, 0x78);
    }
    ...
    public void testORGwithDB() {
        ...
        assertProgram(0, 0, 0, 0x21, 0x06, 0, 'a', 'h', 'o', 'j');
    }
    ...
    public void testORG() {
        ...
        assertProgram(0, 0, 0x78, 0, 0, 0xFE, 0x43, 0xCA, 0x02, 0x00, 0x77);
    }
    ...
    public void testORGwithJumpForwards() {
        ...
        assertProgram(0xC3, 0x05, 0, 0, 0, 0x78);
    }
    ...
    public void testORGdoesNotBreakPreviousMemoryContent() {
        ...
        compile("org 2\n" + "now: mov a,b\n");
        assertProgram(0x10, 0x11, 0x78);
    }

    @Test
    public void testORGthenDSdoNotOverlap() {
        compile("org 2\nds 2\nmov a,b");
        assertProgram(0, 0, 0, 0, 0x78);
    }
