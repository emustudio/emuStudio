...
import net.emustudio.plugins.compiler.as8080.exceptions.InvalidMacroParamsCountException;
import net.emustudio.plugins.compiler.as8080.exceptions.UnknownMacroParametersException;
...
public class MacroPseudoNode extends PseudoBlock {
    ...
    private void createNewEnvForMacro(Namespace env) {
