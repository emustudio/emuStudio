    ...
    public static void main(String... args) {
        ...
        for (i = 0; i < args.length; i++) {
            ...
            if ((arg.equals("--output") || arg.equals("-o")) && ((i + 1) < args.length)) {
                ...
                System.out.println(new Assembler8080(0L, ApplicationApi.UNAVAILABLE, PluginSettings.UNAVAILABLE).getVersion());
                return;
            } else {
                break;
            }
        ...
        Assembler8080 compiler = new Assembler8080(0L, ApplicationApi.UNAVAILABLE, PluginSettings.UNAVAILABLE);
