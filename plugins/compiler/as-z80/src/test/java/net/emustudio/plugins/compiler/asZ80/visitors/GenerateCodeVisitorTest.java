...
public class GenerateCodeVisitorTest {
        ...
        program
            ...
            .addChild(new PseudoMacroCall(0, 0, "x")
                ...
                .addChild(new PseudoMacroCall(0, 0, "y")
                    .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_D)
                        .addChild(new Evaluated(0, 0, 1))))
                .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_H)
    ...
    public void testPseudoOrg() {
        ...
        program
            .addChild(new PseudoOrg(0, 0)
                .addChild(new Evaluated(0, 0, 5)))
            .addChild(new InstrN(0, 0, OPCODE_CNZ)
                .addChild(new Evaluated(0, 0, 0x400)))
            .addChild(new PseudoOrg(0, 0)
                .addChild(new Evaluated(0, 0, 0)))
            .addChild(new Instr(0, 0, OPCODE_XCHG, x, y, z));
    ...
    public void testGenerateInstructions() {
        Program program = new Program();
        program
            .addChild(new Instr(0, 0, OPCODE_NOP, x, y, z))
            .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_B)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrRP(0, 0, OPCODE_STAX, REG_B))
            .addChild(new InstrRP(0, 0, OPCODE_INX, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_B))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_B)
                .addChild(new Evaluated(0, 0, 7)))
            .addChild(new Instr(0, 0, OPCODE_RLC, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_DAD, REG_B))
            .addChild(new InstrRP(0, 0, OPCODE_LDAX, REG_B))
            .addChild(new InstrRP(0, 0, OPCODE_DCX, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_C))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_C)
                .addChild(new Evaluated(0, 0, 8)))
            .addChild(new Instr(0, 0, OPCODE_RRC, x, y, z))
            .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_D)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrRP(0, 0, OPCODE_STAX, REG_D))
            .addChild(new InstrRP(0, 0, OPCODE_INX, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_D))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_D)
                .addChild(new Evaluated(0, 0, 9)))
            .addChild(new Instr(0, 0, OPCODE_RAL, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_DAD, REG_D))
            .addChild(new InstrRP(0, 0, OPCODE_LDAX, REG_D))
            .addChild(new InstrRP(0, 0, OPCODE_DCX, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_E))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_E)
                .addChild(new Evaluated(0, 0, 10)))
            .addChild(new Instr(0, 0, OPCODE_RAR, x, y, z))
            .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_H)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrN(0, 0, OPCODE_SHLD)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrRP(0, 0, OPCODE_INX, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_H))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_H)
                .addChild(new Evaluated(0, 0, 0x28)))
            .addChild(new Instr(0, 0, OPCODE_DAA, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_DAD, REG_H))
            .addChild(new InstrN(0, 0, OPCODE_LHLD)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrRP(0, 0, OPCODE_DCX, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_L))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_L)
                .addChild(new Evaluated(0, 0, 10)))
            .addChild(new Instr(0, 0, OPCODE_CMA, x, y, z))
            .addChild(new InstrRP_NN(0, 0, OPCODE_LXI, REG_SP)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrN(0, 0, OPCODE_STA)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrRP(0, 0, OPCODE_INX, REG_SP))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_M))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_M)
                .addChild(new Evaluated(0, 0, 7)))
            .addChild(new Instr(0, 0, OPCODE_STC, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_DAD, REG_SP))
            .addChild(new InstrN(0, 0, OPCODE_LDA)
                .addChild(new Evaluated(0, 0, 0x2345)))
            .addChild(new InstrRP(0, 0, OPCODE_DCX, REG_SP))
            .addChild(new InstrR(0, 0, OPCODE_INR, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_DCR, REG_A))
            .addChild(new InstrR_N(0, 0, OPCODE_MVI, REG_A)
                .addChild(new Evaluated(0, 0, -128)))
            .addChild(new Instr(0, 0, OPCODE_CMC, x, y, z))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_B, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_C, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_D, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_E, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_H, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_L, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_M)) // HLT
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_M, REG_A))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_B))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_C))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_D))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_E))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_H))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_L))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_M))
            .addChild(new InstrR_R(0, 0, OPCODE_MOV, REG_A, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_ADD, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_ADC, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_SUB, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_SBB, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_ANA, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_XRA, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_ORA, REG_A))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_B))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_C))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_D))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_E))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_H))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_L))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_M))
            .addChild(new InstrR(0, 0, OPCODE_CMP, REG_A))
            .addChild(new Instr(0, 0, OPCODE_RNZ, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_POP, REG_B))
            .addChild(new InstrN(0, 0, OPCODE_JNZ)
            ...
            .addChild(new InstrRP(0, 0, OPCODE_PUSH, REG_B))
            .addChild(new InstrN(0, 0, OPCODE_ADI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 0)))
            .addChild(new Instr(0, 0, OPCODE_RZ, x, y, z))
            .addChild(new Instr(0, 0, OPCODE_RET, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_JZ)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_CZ)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_CALL)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_ACI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 1)))
            .addChild(new Instr(0, 0, OPCODE_RNC, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_POP, REG_D))
            .addChild(new InstrN(0, 0, OPCODE_JNC)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_OUT)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_CNC)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrRP(0, 0, OPCODE_PUSH, REG_D))
            .addChild(new InstrN(0, 0, OPCODE_SUI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 2)))
            .addChild(new Instr(0, 0, OPCODE_RC, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_JC)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_IN)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_CC)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_SBI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 3)))
            .addChild(new Instr(0, 0, OPCODE_RPO, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_POP, REG_H))
            .addChild(new InstrN(0, 0, OPCODE_JPO)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new Instr(0, 0, OPCODE_XTHL, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_CPO)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrRP(0, 0, OPCODE_PUSH, REG_H))
            .addChild(new InstrN(0, 0, OPCODE_ANI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 4)))
            .addChild(new Instr(0, 0, OPCODE_RPE, x, y, z))
            .addChild(new Instr(0, 0, OPCODE_PCHL, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_JPE)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new Instr(0, 0, OPCODE_XCHG, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_CPE)
                .addChild(new Evaluated(0, 0, 0x1234)))
            .addChild(new InstrN(0, 0, OPCODE_XRI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 5)))
            .addChild(new Instr(0, 0, OPCODE_RP, x, y, z))
            .addChild(new InstrRP(0, 0, OPCODE_POP, REG_PSW))
            .addChild(new InstrN(0, 0, OPCODE_JP)
                .addChild(new Evaluated(0, 0, 0x200)))
            .addChild(new Instr(0, 0, OPCODE_DI, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_CP)
                .addChild(new Evaluated(0, 0, 0x200)))
            .addChild(new InstrRP(0, 0, OPCODE_PUSH, REG_PSW))
            .addChild(new InstrN(0, 0, OPCODE_ORI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 6)))
            .addChild(new Instr(0, 0, OPCODE_RM, x, y, z))
            .addChild(new Instr(0, 0, OPCODE_SPHL, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_JM)
                .addChild(new Evaluated(0, 0, 0x200)))
            .addChild(new Instr(0, 0, OPCODE_EI, x, y, z))
            .addChild(new InstrN(0, 0, OPCODE_CM)
                .addChild(new Evaluated(0, 0, 0x200)))
            .addChild(new InstrN(0, 0, OPCODE_CPI)
                .addChild(new Evaluated(0, 0, 0xF0)))
            .addChild(new InstrN(0, 0, OPCODE_RST)
                .addChild(new Evaluated(0, 0, 7)));
