...
public class MemoryDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(BorderFactory.createTitledBorder(
            null, "Tape content", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
            DIALOG_PLAIN)
        );
        ...
        jPanel2.setBorder(BorderFactory.createTitledBorder(
            null, "Details", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
            DIALOG_PLAIN
        ));

        jPanel3.setBorder(BorderFactory.createTitledBorder(
            null, "Statistics", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
            DIALOG_PLAIN
        ));
        ...
        jPanel4.setBorder(BorderFactory.createTitledBorder(
            null, "Uniform Complexity", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
            DIALOG_PLAIN
        ));
