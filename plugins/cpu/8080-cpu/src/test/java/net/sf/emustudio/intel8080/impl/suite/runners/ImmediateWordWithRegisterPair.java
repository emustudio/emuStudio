...
public class ImmediateWordWithRegisterPair implements Function<Integer, RunnerContext<Integer>> {
    private final CpuRunner runner;
    private final int instruction;
    private final int registerPair;
    private final int value;

    public ImmediateWordWithRegisterPair(CpuRunner runner, int instruction, int registerPair, int value) {
        this.value = value;
    ...
    public RunnerContext<Integer> apply(Integer first) {
        ...
        runner.setRegisterPair(registerPair, value);
