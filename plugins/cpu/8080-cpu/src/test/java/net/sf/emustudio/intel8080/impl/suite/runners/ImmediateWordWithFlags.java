...
public class ImmediateWordWithFlags implements Function<Integer, RunnerContext<Integer>> {
    private final CpuRunner runner;
    private final int instruction;
    private final int flags;

    public ImmediateWordWithFlags(CpuRunner runner, int instruction, int flags) {
