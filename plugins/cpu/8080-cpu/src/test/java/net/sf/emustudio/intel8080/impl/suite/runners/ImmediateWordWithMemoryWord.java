...
public class ImmediateWordWithMemoryWord implements Function<Integer, RunnerContext<Integer>> {
    private final CpuRunner runner;
    private final int instruction;
    private final int value;

    public ImmediateWordWithMemoryWord(CpuRunner runner, int instruction, int value) {
