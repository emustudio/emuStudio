...
public class PCAndSPAndMemoryVerifier implements Consumer<RunnerContext<Integer>> {
    private final Function<RunnerContext<Integer>, Integer> operation;
    private final CpuVerifier verifier;

    public PCAndSPAndMemoryVerifier(CpuVerifier verifier, Function<RunnerContext<Integer>, Integer> operation) {
