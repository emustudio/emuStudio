...
public class InstructionPrinterTest {
    ...
    @Test
    public void usesCurrentProgramCounterWhenDisassemblingAndPrinting() {
        ...
        assertEquals(1, disassembler.addresses.size());
        assertEquals(Integer.valueOf(0), disassembler.addresses.get(0));
        assertEquals(1, lines.length);
        assertTrue(lines[0].startsWith("0000 | PC=0000 |"));
    }
    ...
    private static EmulatorEngine createEngine() {
        ...
        return new EmulatorEngine(memory, new ContextZ80Impl());
    }
