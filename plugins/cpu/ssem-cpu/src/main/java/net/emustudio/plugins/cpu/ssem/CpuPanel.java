...
public class CpuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblSpeed.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        lblSpeed.setText("0");
        ...
        jLabel3.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        jLabel3.setText("CI");
        jLabel3.setToolTipText("Control Instruction");

        txtCI.setEditable(false);
        txtCI.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        txtCI.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtCI.setText("0");

        txtA.setEditable(false);
        txtA.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        txtA.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtA.setText("0");

        txtBinA.setEditable(false);
        txtBinA.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        ...
        txtBinCI.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        ...
        jLabel4.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        jLabel4.setText("M[CI]");
        jLabel4.setToolTipText("Control Instruction");

        jLabel5.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        jLabel5.setText("M[line]");
        jLabel5.setToolTipText("Control Instruction");

        txtMLine.setEditable(false);
        txtMLine.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        txtMLine.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMLine.setText("0");

        txtMCI.setEditable(false);
        txtMCI.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        txtMCI.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMCI.setText("0");

        txtBinMCI.setEditable(false);
        txtBinMCI.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        ...
        txtBinMLine.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        ...
        jLabel6.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        jLabel6.setText("line");
        jLabel6.setToolTipText("Control Instruction");

        txtLine.setEditable(false);
        txtLine.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
        txtLine.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtLine.setText("0");

        txtBinLine.setEditable(false);
        txtBinLine.setFont(new java.awt.Font("Monospaced", Font.PLAIN, 12)); // NOI18N
