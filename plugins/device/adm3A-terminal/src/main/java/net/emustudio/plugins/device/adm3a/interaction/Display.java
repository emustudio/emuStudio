...
public class Display extends JPanel implements DeviceContext<Short>, TerminalSettings.ChangedObserver, net.emustudio.plugins.device.adm3a.interaction.Cursor.LineRoller {
    ...
    private final net.emustudio.plugins.device.adm3a.interaction.Cursor cursor;
