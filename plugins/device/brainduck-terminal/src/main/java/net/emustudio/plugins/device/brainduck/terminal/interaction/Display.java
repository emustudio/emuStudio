...
import net.emustudio.plugins.device.brainduck.terminal.Vt100StateMachine;
import net.emustudio.plugins.device.brainduck.terminal.api.OutputProvider;
...
@ThreadSafe
public class Display implements OutputProvider, Cursor.LineRoller, Vt100StateMachine.Vt100Dispatcher {
