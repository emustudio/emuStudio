...
public class Drive {
    ...
    private volatile int sectorsCount = DEFAULT_SECTORS_COUNT;
    private volatile int sectorLength = DEFAULT_SECTOR_LENGTH;

    private volatile int track;
    private volatile int sector;
    private volatile int sectorOffset;
