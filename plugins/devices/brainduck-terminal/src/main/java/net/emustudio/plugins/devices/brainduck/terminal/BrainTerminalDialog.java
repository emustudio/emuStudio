...
import net.emustudio.plugins.devices.brainduck.terminal.io.*;
...
class BrainTerminalDialog extends JDialog implements OutputProvider, Keyboard.KeyboardListener {
    ...
    private BrainTerminalDialog(Keyboard keyboard) {
        URL blueIconURL = getClass().getResource(
            "/net/emustudio/plugins/devices/brainduck/terminal/16_circle_blue.png"
        );
        URL redIconURL = getClass().getResource(
            "/net/emustudio/plugins/devices/brainduck/terminal/16_circle_red.png"
        );
        URL greenIconURL = getClass().getResource(
            "/net/emustudio/plugins/devices/brainduck/terminal/16_circle_green.png"
        );
    ...
    private void initComponents() {
        ...
        btnASCII.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/emustudio/plugins/devices/brainduck/terminal/16_ascii.png"))); // NOI18N
