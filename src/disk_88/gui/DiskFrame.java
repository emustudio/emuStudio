...
public class DiskFrame extends JFrame {
    ...
    private void updateDriveInfo(Drive d) {
        if (drives.indexOf(d) != driveInfoIndex) {
            return;
        }
    ...
    public void select(Drive dr, boolean sel) {
        ...
        if (sel) {
            fil = "/disk_88/resources/on.gif";
        } else {
            fil = "/disk_88/resources/off.gif";
        }
        switch (drive) {
            case 0:
    ...
    private void initComponents() {
        ...
        panelDrivesLayout.setHorizontalGroup(
                panelDrivesLayout.createSequentialGroup().addContainerGap().addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn0, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn8, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn1, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn9, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn2, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn10, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn3, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn11, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn4, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn12, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn5, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn13, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn6, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn14, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(btn7, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btn15, 10, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addContainerGap());
        panelDrivesLayout.setVerticalGroup(
                panelDrivesLayout.createSequentialGroup().addContainerGap().addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(btn0).addComponent(btn1).addComponent(btn2).addComponent(btn3).addComponent(btn4).addComponent(btn5).addComponent(btn6).addComponent(btn7)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panelDrivesLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(btn8).addComponent(btn9).addComponent(btn10).addComponent(btn11).addComponent(btn12).addComponent(btn13).addComponent(btn14).addComponent(btn15)).addContainerGap());
        ...
        driveInfoPanelLayout.setHorizontalGroup(
                driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(driveInfoPanelLayout.createSequentialGroup().addContainerGap().addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(lblFlagsLBL).addComponent(lblTrackLBL).addComponent(lblSectorLBL).addComponent(lblOffsetLBL)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(lblFlags).addComponent(lblTrack).addComponent(lblSector).addComponent(lblOffset)).addContainerGap()).addGroup(driveInfoPanelLayout.createSequentialGroup().addContainerGap().addComponent(txtImage).addContainerGap()));
        driveInfoPanelLayout.setVerticalGroup(
                driveInfoPanelLayout.createSequentialGroup().addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(lblFlagsLBL).addComponent(lblFlags)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(lblTrackLBL).addComponent(lblTrack)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(lblSectorLBL).addComponent(lblSector)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(driveInfoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(lblOffsetLBL).addComponent(lblOffset)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(txtImage).addContainerGap());

        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
                layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(panelSelectedDrives, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE).addComponent(driveInfoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addContainerGap());
        layout.setVerticalGroup(
                layout.createSequentialGroup().addContainerGap().addComponent(panelSelectedDrives, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(driveInfoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap());
        pack();
    }
