...
public class statusGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        paneRegisters.setBorder(BorderFactory.createTitledBorder(
        		...
        		paneRegisters.getFont().deriveFont(Font.BOLD, 14),
        		Color.gray)); // NOI18N
        ...
        panelSET1Layout.setHorizontalGroup(
    		panelSET1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
	            ...
	            .addGroup(panelSET1Layout.createSequentialGroup()
	            		...
	            		.addContainerGap()));
        panelSET1Layout.setVerticalGroup(panelSET1Layout.createSequentialGroup()
        		.addContainerGap()
        ...
        panelSET2Layout.setHorizontalGroup(
        		panelSET2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
    	            ...
    	            .addGroup(panelSET2Layout.createSequentialGroup()
    	            		...
    	            		.addContainerGap()));
            panelSET2Layout.setVerticalGroup(panelSET2Layout.createSequentialGroup()
            		.addContainerGap()
