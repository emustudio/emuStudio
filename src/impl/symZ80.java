...
public interface symZ80 {
  /* terminals */
  public static final int OPERATOR_AND = 119;
  public static final int RESERVED_RRCA = 58;
  public static final int OPERATOR_SUBTRACT = 112;
  ...
  public static final int OPERATOR_XOR = 121;
  ...
  public static final int OPERATOR_LE = 125;
  public static final int TIDENTIFIER = 131;
  public static final int RESERVED_SRL = 66;
  public static final int RESERVED_IND = 25;
  public static final int RESERVED_INC = 24;
  public static final int OPERATOR_DIVIDE = 114;
  ...
  public static final int OPERATOR_GREATER = 124;
  public static final int OPERATOR_EQUAL = 122;
  public static final int OPERATOR_SHR = 116;
  public static final int LITERAL_STRING = 129;
  public static final int OPERATOR_NOT = 118;
  public static final int LITERAL_DECIMAL_16BIT = 128;
  public static final int OPERATOR_SHL = 117;
  ...
  public static final int LITERAL_DECIMAL_8BIT = 127;
  public static final int OPERATOR_MOD = 115;
  public static final int OPERATOR_MULTIPLY = 113;
  ...
  public static final int OPERATOR_OR = 120;
  ...
  public static final int OPERATOR_ADD = 111;
  ...
  public static final int OPERATOR_LESS = 123;
  ...
  public static final int TLABEL = 130;
