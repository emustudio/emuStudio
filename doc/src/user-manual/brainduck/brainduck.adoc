...
image::images/status-panel.png[BrainDuck CPU status panel]
...
image::images/brainduck-mem.png[BrainDuck memory window]
...
image::images/brainduck-terminal.png[BrainDuck terminal window]
...
image::images/brainduck-terminal-input.png[Input is enabled in BrainDuck terminal window]
