...
and `getDisassembler()`. Those two methods will return the components, mentioned first in section <<WHAT_CPU_DOES>>.
...
----
include::../../../plugins/cpu/ssem-cpu/src/main/java/net/sf/emustudio/ssem/cpu/CpuPanel.java[]
----
