...
.`ssem-mem/pom.xml`
----
include::../../../plugins/mem/ssem-mem/pom.xml[]
----
...
footnote:[See "How to write a CPU for emuStudio" tutorial for more information about Edigen].
...
main interface, presented in section <<BASIC_STUFF>>, is the communication point with emuStudio. The main module is
...
if it requires some. More on this topic can be found in the "Introduction for writing virtual computers" guide.
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/impl/MemoryContextImpl.java[]
----
...
image::images/ssem-memory.png[SSEM Memory GUI sample look]
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/MemoryGUI.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/MemoryTable.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/MemoryTableModel.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/RowHeaderRenderer.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/CellRenderer.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/main/java/net/sf/emustudio/ssem/memory/gui/CellEditor.java[]
----
...
----
include::../../../plugins/mem/ssem-mem/src/test/java/net/sf/emustudio/ssem/memory/impl/MemoryContextImplTest.java[]
----
