...
MVBYTS:	POP  H			;HL (M)=0000H FIRST TIME
LXI  D,VAR3		;DE POINTS TO BUFFER + 3
LXI  B,0080h		;B=0=CRC C=128 COUNT
MVBYT2:	LDAX D			;GET BYTE FROM BUFFER
...
OERROR:	MVI  A,4Fh		;	LOAD A WITH CHAR 'O'VERFLOW
DB  01h
;4CC0			LXI  B,4D3E		;GARBAGE - SKIP TRICK C0-C2
MERROR:	MVI  A,4D		;	LOAD A WITH CHAR 'M'EMORY ERROR
MOV  B,A		;SAVE CHAR
MVI  A,80h		;CLEAR CONTROLLER
OUT  08h			;SEND CLEAR
MOV  A,B		;GET CHAR

CONOUT:	OUT  11h		;SEND ERROR CHAR TO CONSOLE
