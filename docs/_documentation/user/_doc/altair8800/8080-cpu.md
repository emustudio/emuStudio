...
Configuration file of virtual computers contain also settings of all the used plug-ins, including CPUs. The following table shows all the possible settings of Intel 8080 CPU plug-in:
