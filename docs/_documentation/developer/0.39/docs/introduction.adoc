...
CAUTION: emuStudio uses Maven for the net.emustudio.architecture.build lifecycle management. All dependencies and their versions are defined in
...
[graphviz,net.emustudio-plugins,svg]
---------------------------------------------------------------------
...
Maven is a standard for Java projects today. It helps with the net.emustudio.architecture.build process and manages dependencies in satisfying
and reusable way.
...
<distributionManagement>
  <repository>
    <id>net.emustudio-repository</id>
    <name>emuStudio Repository</name>
    <url>sftp://web.sourceforge.net:/home/project-web/net.emustudio/htdocs/repository</url>
  </repository>
</distributionManagement>
----
...
----
    <dependencySet>
      <includes>
        ...
        <include>net.sf.net.emustudio:as-ssem</include>
      </includes>
      ...
