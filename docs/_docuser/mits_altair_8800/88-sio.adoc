...
image::{imagepath}/88-sio-ports.png[Setting CPU ports]
...
As can be seen; the two SIO ports can be attached to multiple CPU ports. By default, the used CPU ports are:

- Status port: 0x03, 0x10, 0x14, 0x16, 0x18
- Data port: 0x02, 0x11, 0x15, 0x17, 0x19
