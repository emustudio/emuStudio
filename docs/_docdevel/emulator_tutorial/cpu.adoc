...
----
include::{sourcedir}/plugins/cpu/ssem-cpu/src/main/java/net/sf/emustudio/ssem/cpu/CpuPanel.java[lines=20..-1]
----
...
----
include::{sourcedir}/plugins/cpu/ssem-cpu/src/main/java/net/sf/emustudio/ssem/cpu/AutomaticEmulation.java[lines=20..-1]
----
