...
.`pom.xml`
----
include::{sourcedir}/plugins/cpu/ssem-cpu/pom.xml[]
----
...
----
include::{sourcedir}/plugins/cpu/ssem-cpu/src/main/edigen/cpu.eds[]
----
...
----
include::{sourcedir}/plugins/cpu/ssem-cpu/src/main/java/net/sf/net.emustudio/ssem/cpu/CpuPanel.java[lines=20..-1]
----
...
----
include::{sourcedir}/plugins/cpu/ssem-cpu/src/main/java/net/sf/net.emustudio/ssem/cpu/AutomaticEmulation.java[lines=20..-1]
----
