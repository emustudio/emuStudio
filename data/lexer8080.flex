...
"stc" {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.RESERVED,text,null,yyline,yycolumn,
...
"org" {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.PREPROCESSOR,text,null,yyline,
...
"a" {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.REGISTER,text,null,yyline,
        yycolumn,yychar,yychar+text.length()));
}
"b" {
...
"(" {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.SEPARATOR,text,null,yyline,
        yycolumn,yychar,yychar+text.length()));
}
")" {
...
"+" {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.OPERATOR,text,null,yyline,yycolumn,
        yychar,yychar+text.length()));
}
"-" {
...
{Comment} {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.COMMENT,text,null,yyline,yycolumn,
        yychar,yychar+text.length()));
}
...
{UnclosedString} {
    ...
    String text = yytext();
    return (new token8080(lastToken,emu8Token.ERROR,text,null,yyline,yycolumn,
        yychar,yychar+text.length()));
}
{String} {
    String text = yytext();
    ...
    if (val.length() > 2) {
        ...
        return (new token8080(lastToken,emu8Token.LITERAL,text,val,yyline,yycolumn,
            yychar,yychar+text.length()));
    }
    else {
        byte[] b = val.getBytes();
        ...
        return (new token8080(lastToken,emu8Token.LITERAL,text,numval,yyline,yycolumn,
            yychar,yychar+text.length()));
    }
}
{Identifier} {
    ...
    return (new token8080(lastToken,emu8Token.IDENTIFIER,text,val,yyline,
        yycolumn,yychar,yychar+text.length()));
}
{Label} {
    ...
    return (new token8080(lastToken,emu8Token.LABEL,text,val,yyline,yycolumn,
        yychar,yychar+text.length()));
}
